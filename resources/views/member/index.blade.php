            ...
            <div class="col-lg-20 order-0">
              <div class="card">
                <div class="d-flex align-items-end row">
                  <div class="col-sm-7">
                    <div class="card-body">
                      <h5 class="card-title text-primary">Member</h5>
                      <p class="mb-4">
                        You have done <span class="fw-bold">72%</span> more sales today. Check your new badge in
                        your profile.
                      </p>

                      <a href="{{ route('addmember') }}" class="btn btn-sm btn-outline-primary">
...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-2 mb-4"><span class="text-muted fw-light">Data/</span> Member</h4>
  <div class="card">
          ...
          <table class="table table-striped table-hover">
            ...
            <?php $i = $data->firstItem() ?>
              ...
              <tr>
                ...
                <td class="align-middle text-center">{{ $item->kode_member }}</td>
                ...
                <td class="text-center align-middle">
                  <a href="{{ route('member.edit', $item->id_member) }}">
                    <button type="button" class="btn btn-sm btn-primary rounded-pill">Edit</button>
                  </a>
                  <form onsubmit="return confirm('Yakin ingin menghapus produk?')" class="d-inline" action="{{ url('member/'.$item->id_member) }}" method="POST">
                    @csrf
                    @method('DELETE')
