...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tambah</span> Member</h4>
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <small class="text-muted float-end">Tambahkan member</small>
          </div>
          <div class="card-body">
            <form action="{{ url('member') }}" method="POST">
              @csrf
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-company">Nama Member</label>
                <div class="col-sm-10">
                  <input
                    type="text"
                    class="form-control"
