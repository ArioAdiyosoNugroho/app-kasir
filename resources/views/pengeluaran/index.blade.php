...
<div class="content-wrapper">
            ...
            <div class="col-lg-20 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">pengeluaran</h5>
                                <p class="mb-4">
                                    You have done <span class="fw-bold">72%</span> more sales today. Check your new badge in
                                    your profile.
                                </p>

                                <a href="{{ route('addpengeluaran') }}" class="btn btn-sm btn-outline-primary">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-2 mb-4"><span class="text-muted fw-light">Data/</span> pengeluaran</h4>
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="m-0">pengeluaran</h5>
                <form action="{{ url('pengeluaran') }}">
                    <div class="input-group" style="max-width: 300px;">
                        <span class="input-group-text bg-light border-light rounded-start-pill">
                            <i class='bx bx-search'></i>
                        </span>
                        <input type="text" name="katakunci" id="katakunci" class="form-control border-light rounded-end-pill" placeholder="Cari pengeluaran..." value="{{ request::get('katakunci') }}" onkeyup="searchTable()" style="box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.05);">
                    </div>
                </form>
            </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">{{ $item->deskripsi }}</td>
                            <td class="align-middle text-center">{{ $item->formatted_nominal }}</td>
                            <td class="text-center align-middle">
                                ...
                                <form onsubmit="return confirm('Yakin ingin menghapus pengeluaran?')" class="d-inline" action="{{ route('pengeluaran.destroy', $item->id_pengeluaran)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
