<x-header> Edit Produk</x-header>
<x-sidebar></x-sidebar>
<!-- Content -->

<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit</span> Produk</h4>
                ...
                <div class="col-sm-10">
                  <select class="form-select" name="id_kategori" id="id_kategori">
                    ...
                    @foreach ($kategori as $item)
                        <option value="{{ $item->id_kategori }}" {{ $produk->id_kategori == $item->id_kategori ? 'selected' : '' }}>{{ $item->nama_kategori }}</option>
                    @endforeach
                </select>
